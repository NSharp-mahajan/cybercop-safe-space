...
-- RLS policies for FIR submissions
...
-- RLS policies for password checks
...
-- RLS policies for scanned documents
...
-- RLS policies for scam library (public read)
CREATE POLICY "Anyone can read scam library" ON public.scam_library
  FOR SELECT USING (true);

-- RLS policies for law modules (public read)
...
('Introduction to Cyber Law', 'Basic understanding of cyber law principles in India', 
 'Cyber law encompasses legal issues related to the use of the internet, computers, and digital technologies. The Information Technology Act, 2000 is the primary legislation governing cyber law in India. It covers various aspects including electronic governance, digital signatures, cyber crimes, and data protection. Understanding these fundamentals is crucial for anyone working in the digital space.', 
...
('Types of Cyber Crimes', 'Understanding different categories of cyber crimes', 
 'Cyber crimes can be broadly categorized into crimes against individuals, property, and government. Crimes against individuals include harassment, stalking, and identity theft. Crimes against property involve hacking, data theft, and financial fraud. Crimes against government include cyber terrorism and attacks on critical infrastructure. Each category has specific legal provisions and penalties under the IT Act.', 
